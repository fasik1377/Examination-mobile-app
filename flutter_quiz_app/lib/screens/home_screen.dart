    ...
    return Drawer(
      child: ListView(
        ...
        children: [
          ...
          ListTile(
            title: const Text('Home', style: TextStyle(fontSize: 20, fontWeight:FontWeight.w300)),
            onTap: () {
          ...
          Divider(),
          ListTile(
            title: const Text('Start Quiz', style: TextStyle(fontSize: 20, fontWeight: FontWeight.w300),),
            onTap: () async {
          ...
          Divider(),
          ListTile(
            title: const Text('Quiz Category', style: TextStyle(fontSize: 20, fontWeight: FontWeight.w300)),
            onTap: () {
          ...
          Divider(),
          ListTile(
            title: const Text('Quiz History', style: TextStyle(fontSize: 20, fontWeight: FontWeight.w300)),
            onTap: () {
          ...
          ListTile(
            title: const Text('About', style: TextStyle(fontSize: 20, fontWeight: FontWeight.w300)),
            onTap: () {
              AlertUtil.showAlert(context, "About us", "Fasika Abera, Email:- fasikabera1@gmail.com");
            },
          ),
          Divider(),
          ListTile(
            title: const Text('Exit',style: TextStyle(fontSize: 20, fontWeight: FontWeight.w300)),
            onTap: () {
  ...
  Widget drawerToggleButton() {
    return Container(
      ...
      child: GestureDetector(
        child: Image(
          image: AssetImage("assets/icons/menub1.png"),
          width: 60,
        ),
        onTap: () {
